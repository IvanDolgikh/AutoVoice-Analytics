...
const sessions = reactive([
  { id:1, employee:'Лебедев П.Р.',    coach:'Суворов М.К.', date:'2026-06-02', status:'done',      scoreBefore:54, scoreAfter:61, topic:'Создание срочности, взятие контакта', notes:'Провели разбор 3 звонков. Менеджер осознал проблему с окончанием звонка без договорённостей. Назначена следующая сессия через 2 недели.', focus:['Создание срочности','Взял контакт','Следующий контакт'] },
  { id:2, employee:'Григорьев А.В.',  coach:'Суворов М.К.', date:'2026-06-04', status:'done',      scoreBefore:62, scoreAfter:68, topic:'Тест-драйв, срок покупки', notes:'Обсудили важность предложения тест-драйва. Провели ролевую игру. Показатели улучшились.', focus:['Тест-драйв','Срок покупки'] },
