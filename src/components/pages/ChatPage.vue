...
const promptSets = {
  director: [
    { icon: 'pi-chart-bar',           text: 'Какой средний балл по команде за февраль?' },
...
const rules = [
  {
    match: ['средний балл', 'показател', 'как дела', 'февраль', 'статистик', 'обзор', 'сводк', 'итог'],
    parts: () => [
      { type: 'p', text: 'За февраль 2025 года команда в целом показывает стабильный результат. Вот ключевые показатели:' },
      { type: 'kpi', items: [
        { label: 'Средний балл', value: '78%', cls: 'ok', trend: '↑ +3% к январю' },
        { label: 'Звонков проверено', value: '212', cls: 'brand', trend: '' },
        { label: 'Норма (≥80%)', value: '5 / 12', cls: 'ok', trend: '' },
        { label: 'Нарушений', value: '31', cls: 'bad', trend: '↓ −8 к январю' }
      ]},
  ...
  },
  {
    ...
    parts: () => [
      { type: 'p', text: 'Топ-5 сотрудников по среднему баллу за февраль:' },
      { type: 'table',
  ...
  },
  {
    ...
    parts: () => [
      { type: 'p', text: 'Конверсионная воронка отдела продаж за февраль 2025:' },
      { type: 'table',
  ...
  },
  {
    ...
    parts: () => [
      { type: 'p', text: 'Динамика среднего балла команды по неделям за февраль:' },
      { type: 'kpi', items: [
...
const greeting = [
  ...
  { type: 'tip', text: 'Спросите меня о показателях команды, конкретном критерии или попросите дать рекомендации — я отвечу на основе реальных данных за февраль 2025.' }
]

const chats = reactive([
  {
    id: 1,
    title: 'Анализ команды — февраль',
    date: '04.02',
    messages: [
      makeMsg('assistant', greeting, ''),
      makeMsg('user', null, 'Какой средний балл по команде за февраль?'),
      makeMsg('assistant', findResponse('средний балл за февраль'), ''),
